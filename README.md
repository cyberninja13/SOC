...
80 HTPP Hypertext Transfer Protocol (HTTP) used in World Wide Web

443 HTTPs Secure (HTTPS) HTTP over TLS/SSL

110 (POP3) used by e-mail clients to retrieve e-mail from a server
